...
yt-dlp --playlist-end 20 --ignore-errors --no-download --write-info-json --output "dati_grezzi/%(id)s" "https://www.youtube.com/@pingpongstyles"
yt-dlp --playlist-end 20 --ignore-errors --no-download -t sleep --write-info-json --output "dati_grezzi/%(id)s" "https://www.youtube.com/@Fitetofficial"
